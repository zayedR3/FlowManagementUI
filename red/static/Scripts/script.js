...
function openTab(tabName) {
    ...
    for (var i = 0; i < tabContents.length; i++) {
        ...
        document.getElementById(tabContents[i].id + "-tab").style.backgroundColor = "rgba(255, 0, 0, 0.8)";
    }
    ...
    if (selectedTab) {
        ...
        document.getElementById(tabName + "-tab").style.backgroundColor = "rgba(255, 0, 0, 0.4)";
    }
}
